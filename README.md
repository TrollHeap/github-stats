...
3. Go to the "Secrets" page of your copy of the repository. If this is the
   ...
   EXCLUDE LANG : TeX, tex, TSQL, tsql, templ, MDX, PLpgSQL, html, HTML, css, CSS, Java, Hack, Javascript, Makefile, Blade, Dockerfile, cpp, CPP, latte, Latte, dtrace, Dtrace, vim, powershell, vimscript, ampl, CMake, CMAKE, cmake, jinja, Jinja, qml, QML, Astro, astro
